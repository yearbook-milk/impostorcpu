...
def callbackfunc(key):
    ...
    fileio('bus1in.bus', 'w', key)

buttons = []

root = tk.Tk()
buttons.append(tk.Button(text='1 UP    ', command=lambda: callbackfunc('31')))
buttons.append(tk.Button(text='2 DOWN  ', command=lambda: callbackfunc('32')))
...
buttons.append(tk.Button(text='7       ', command=lambda: callbackfunc('37')))
buttons.append(tk.Button(text='8       ', command=lambda: callbackfunc('38')))
