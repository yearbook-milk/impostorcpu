#this script handles reading instru
# ctions and starting their executions
import memhandler
import mathshandler
import boolhandler
import time
...
#the actual program
def execute_program(startaddr, barray):
    # bus wipe on host
    fileio('bus1in.bus','w')
    fileio('bus2in.bus','w')
    ...
    while keepon:
        print('current pointer: 00000005',memhandler.getbyte('00000005'))
        for i in range(0, 11):
            app = memhandler.getbyte(memhandler.getbyte('00000005'))
            print('adrload:',memhandler.getbyte('00000005'))
        ...
        #jump handling
            ...
            if not execute:
                #print(barray)
                #print(hex(int(memhandler.getbyte('00000005'),16) - 5))
                #print(int(memhandler.getbyte('00000005'),16) - 5)
                nh_nextaddr = barray.index('BF', int(memhandler.getbyte('00000005'),16) - int('A0000000', 16)) + int('A0000000', 16)
                #print(nh_nextaddr, barray[nh_nextaddr])
            ...
            fileio('log.txt','a','setreturn('+str(int1)+ops[current_ins[6]]+str(int2)+')\n')
...
execute_program('A0000000', bytelist)
