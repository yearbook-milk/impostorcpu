...
def pxwrite(right,down,thic=3):
    print('pxwrite()',right,down,thic)
    global debug, img, white, black
    img[down*thic-thic:down*thic+thic,right*thic-thic:right*thic+thic] = white
...
def depxwrite(right,down,thic=3):
    print('depxwrite()',right,down,thic)
    global debug, img, white, black
    img[down*thic-thic:down*thic+thic,right*thic-thic:right*thic+thic] = black
